...
;(function(window) {
	 ...
	 * Elastic Slideshow
	 */
	function ElasticSlideshow(el, options) {
		this.el = el;
		this.options = extend( {
			itemSelector: '.slide',
		}, this.options );
	...
	ElasticSlideshow.prototype.options = {};

	ElasticSlideshow.prototype._init = function() {
		// add navigation ctrls and left & right circles to the DOM
		this.navLeftCtrl = document.querySelector('.navbutton.navbutton--next');
		this.navRightCtrl = document.querySelector('.navbutton.navbutton--prev');
	...
	ElasticSlideshow.prototype._initEvents = function() {
		var self = this;
	...
	ElasticSlideshow.prototype._navigate = function(dir) {
		if( this.isExpanded ) {
			return false;
		}
	...
	ElasticSlideshow.prototype._moveCircles = function(dir) {
		var animProps = {
	...
	window.ElasticSlideshow = ElasticSlideshow;
